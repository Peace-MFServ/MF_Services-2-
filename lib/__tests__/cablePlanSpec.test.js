...
describe.each([
  ...
  it("the voltage supply is mandatory", () => {
    const comp = system.components.find(c => c.position === "1")
...
describe("ETS 73 double-leaf sheet fidelity", () => {
  ...
  it("the system cable at 4 is mandatory — twin drives always communicate", () => {
    const comp = double.components.find(c => c.position === "4")
